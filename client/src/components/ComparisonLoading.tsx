...
export default function ComparisonLoading({ onComplete }: { onComplete: () => void }) {
    const [step, setStep] = useState(0);

    const steps = [
        "Fetching public portfolio...",
        "Normalizing positions...",
        "Preparing strategic comparison..."
    ];
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[500px] gap-8 animate-in fade-in duration-500">
            <div className="relative">
                {/* Visual - Chess Knight or similar */}
            ...
            <div className="flex flex-col items-center gap-4">
                <h3 className="text-2xl font-display font-bold text-board-light">Scouting Opponent...</h3>
